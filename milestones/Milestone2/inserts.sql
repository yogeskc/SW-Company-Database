...
-- Purpose: To Insert data into the Database
...
SELECT * FROM CompanyRules;
	INSERT INTO CompanyRules(privacypolicy, termsofuse, announcement_id)
		  VALUES("Privacy 1", "Terms 1", 1),("Privacy 1", "Terms 1", 2),("Privacy 1", "Terms 1", 3);
...
SELECT * FROM WorkHours;
	INSERT INTO WorkHours(hours,jobid,workid)
		VALUES(1,1,1),(2,1,1),(3,1,1); 

SELECT * FROM Status; 
	INSERT INTO Status(pid,complete,incomplete) 
		VALUES(1,1,1),(2,0,1),(3,1,0);
    
SELECT * FROM Device;
	INSERT INTO Device(device_id,complete, pid)
		VALUES(1,1,1),(2,2,2),(3,3,3);
        
SELECT * FROM Device_Log; 
	INSERT INTO Device_Log(reg_acc_id,device_id)
		VALUES(1,1),(2,2),(3,3); 

SELECT * FROM ProcessPayment;
		INSERT INTO ProcessPayment(device_id, employee_id)
			VALUES (1,1),(2,1),(3,1);

SELECT * FROM PaymentInfo;
	INSERT INTO PaymentInfo(payment_id,device_id)
		VALUES (2,1),(3,2),(4,3);

SELECT * FROM bank_account;
	INSERT INTO bank_account(bank_id)
		 VALUES(124),(123),(110);

SELECT * FROM CreditCard; 
	INSERT INTO CreditCard(card_id)
		VALUES(11),(13),(12);